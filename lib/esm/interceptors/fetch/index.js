import { Headers, flattenHeadersObject, objectToHeaders, headersToObject, } from 'headers-polyfill';
...
export class FetchInterceptor extends Interceptor {
    ...
    setup() {
        ...
        globalThis.fetch = async (input, init) => {
            ...
            const isomorphicRequest = new IsomorphicRequest(new URL(url, location.origin), {
                body,
                method,
            ...
            return pureFetch(request).then(async (response) => {
                ...
                this.emitter.emit('response', interactiveIsomorphicRequest, await normalizeFetchResponse(cloneResponse));
                return response;
            });
        };
